...
//    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid Lastname Supplied", content = @Content)
    })
    @GetMapping("/teachers")
...
//            throw e;
    ...
    public ResponseEntity<TeacherReadOnlyDTO> getTeacherById(@PathVariable("id") Long id)  {
        Teacher teacher;
    ...
    @Operation(summary = "Delete a teacher with id")
    @ApiResponses(value = {
    ...
    public ResponseEntity<TeacherReadOnlyDTO> deleteTeacher(@PathVariable("id") Long id)  {
        try {
            ...
            TeacherReadOnlyDTO readOnlyDTO = Mapper.mapToReadOnlyDTO(teacher);
//            return ResponseEntity.ok().body(readOnlyDTO);
